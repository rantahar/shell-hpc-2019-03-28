...
carpentry: "sa2c"    # what kind of Carpentry (must be either "lc" or "dc" or "swc")
venue: "Wallace 218"        # brief name of host site without address (e.g., "Euphoric State University")
address: "Room 218, Wallace Building, Swansea University, Singleton Park, Swansea SA2 8PP"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
latlng: "51.608149, -3.981953"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
humandate: "December 11, 2018"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
helper: ["Mark Dawson", "Chennakesava Kadapa"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
recon_channel: "https://recon.swansea.ac.uk/#narrow/stream/20-shell-hpc-2018-12-11"       # optional: url for specific recon channel to join
---
